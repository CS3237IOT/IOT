...
class DataCollector:
    ...
    def output(self):
        ...
        print('{datetime.datetime.now()}: {self.optical}, {self.humidity}, {self.humidty_temperature}, {self.barometer}, {self.barometer_temperature}')
        self.write_to_csv()
...
if __name__ == "__main__":
    ...
    address = (
        ...
        #"6FFBA6AE-0802-4D92-B1CD-041BE4B4FEB9"
    )
